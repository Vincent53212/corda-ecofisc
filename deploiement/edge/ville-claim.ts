...
const __mod: { exports: Record<string, unknown> } = { exports: {} };
{
  ...
  (function (root, factory) {
    ...
    const DESCRIPTIONS = {
      ...
      m11:"Redevance d'un montant fixe perçue sur chaque course de transport rémunéré de personnes (taxis et services par application), collectée auprès des répondants et versée à la municipalité, dont le produit finance le transport collectif et l'entretien du réseau routier local sollicité par ces déplacements.",
      ...
      m35:"Taxe annuelle sur les panneaux d'affichage et enseignes publicitaires situés sur le territoire, modulée selon la superficie, le type (statique ou numérique) ou l'emplacement : à la fois source de revenu et levier d'encadrement de l'affichage et de la pollution visuelle.",
